...
<body>
    ...
    <aside id="sidebar">
        <div class="sidebar-header">File Manager</div>
    ...
    <div id="context-menu" class="context-menu">
        ...
        <div class="menu-item" onclick="handleMenuAction('cut')">✂️ Cut</div> <div class="menu-item" onclick="handleMenuAction('paste')">📋 Paste</div>
        <hr>
